...
import sty from "./PlasmicBlogPost.module.css"; // plasmic-import: VW9Ov9wvUMlr/css
...
function PlasmicBlogPost__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__swrVw, {
          [sty.freeBoxlong__swrVwK5Z6F]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__v3Mtv)}
              displayHeight={"auto"}
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__lCpn7, {
          [sty.freeBoxlong__lCpn7K5Z6F]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
