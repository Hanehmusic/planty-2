...
import sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: o1paKEyJSpbn/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__ubE7I)}>
        <div className={classNames(projectcss.all, sty.freeBox___73XSj)} />

        <div className={classNames(projectcss.all, sty.freeBox__j51TM)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__hrKyf)}
          >
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__tJuWd)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__mpDDc)}
            >
              <LinkButton
