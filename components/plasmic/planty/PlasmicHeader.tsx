...
import sty from "./PlasmicHeader.module.css"; // plasmic-import: _UDy3LRxmkQV/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__dHnIz)}
      >
        <MenuButton
        ...
        <PlasmicLink__
          className={classNames(projectcss.all, projectcss.a, sty.link__j5Qjs)}
          component={Link}
          href={`/`}
          platform={"nextjs"}
        >
          <LogoWhiteSvgIcon
            a={""}
            className={classNames(projectcss.all, sty.svg__qiyXi)}
            role={"img"}
          />
        </PlasmicLink__>
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__vbSnu, {
            [sty.freeBoxexpanded__vbSnu2Plgb]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__gvwiX)}
        >
          <IconLink
            ...
            icon={
              <React.Fragment>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__kwAX)}
                  role={"img"}
                />
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__bCtO, {
          [sty.freeBoxexpanded__bCtO2Plgb]: hasVariant(
            $state,
            "expanded",
            "expanded"
          )
      ...
      >
        <LinkButton
          className={classNames("__wab_instance", sty.linkButton__a4CS0)}
          text={"Home"}
          type={"blankGray"}
        />

        <LinkButton
          className={classNames("__wab_instance", sty.linkButton__wdjuC)}
          text={"New Arrival"}
          type={"blankGray"}
        />

        <LinkButton
          className={classNames("__wab_instance", sty.linkButton__islFx)}
          text={"Features"}
          type={"blankGray"}
        />

        <LinkButton
          className={classNames("__wab_instance", sty.linkButton__ziRpo)}
          text={"Blog"}
          type={"blankGray"}
        />

        <LinkButton
          className={classNames("__wab_instance", sty.linkButton__nrlnf)}
          text={"Contact"}
          type={"blankGray"}
        />
      </div>
