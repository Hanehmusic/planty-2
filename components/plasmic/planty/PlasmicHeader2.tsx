...
import sty from "./PlasmicHeader2.module.css"; // plasmic-import: WUH7VfVxhz1m/css

import Logo4SvgIcon from "./icons/PlasmicIcon__Logo4Svg"; // plasmic-import: 15noePGCX54h/icon
...
function PlasmicHeader2__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <PlasmicLink__
        className={classNames(projectcss.all, projectcss.a, sty.link__g44Bc)}
        component={Link}
        href={`/`}
        platform={"nextjs"}
      >
        <Logo4SvgIcon
          className={classNames(projectcss.all, sty.svg__vm0Gw)}
          role={"img"}
        />
      </PlasmicLink__>
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__bqz58)}
      >
        <PlasmicLink__
          className={classNames(
            projectcss.all,
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__vx7KE)}
      >
        <IconLink
          ...
          icon={
            <React.Fragment>
              <IconIcon
                className={classNames(projectcss.all, sty.svg__pFeFn)}
                role={"img"}
              />
