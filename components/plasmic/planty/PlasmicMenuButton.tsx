...
import sty from "./PlasmicMenuButton.module.css"; // plasmic-import: mayIk_3OkhFT/css

import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: tK5S785TRCb1/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: FZITPainjsOo/icon
...
function PlasmicMenuButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <BarsIcon
          className={classNames(projectcss.all, sty.svg___7Aupz, {
            [sty.svgexpanded___7Aupz4B5VC]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
        ...
        <TimesIcon
          className={classNames(projectcss.all, sty.svg__orlsK, {
            [sty.svgexpanded__orlsK4B5VC]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
